#!/usr/bin/env python3
"""
Simple Trading Picks Display - Actually Readable Format
"""
import sys
import os
...
def display_simple_trading_picks():
    """Display trading picks in simple, readable format"""
    ...
    # Simple table format with clear separators
    print('TRADING PICKS TABLE:')
    print('=' * 80)
    print()
    
    # Header
    print(f"{'Symbol':<8} {'Type':<6} {'Stop Loss':<20} {'Take Profit':<20} {'Stars':<8} {'Probability'}")
    print('-' * 80)
    ...
    for pick in picks:
        ...
        print(f"{symbol:<8} {setup_type:<6} {stop_loss:<20} {take_profit:<20} {stars:<8} {probability}")
    
    print('-' * 80)
    print()
    
    # Detailed view of each pick
